...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    try {
        ...
        $existingUser = R::findOne('users', 'phone = ? OR email = ? OR login = ?', [$phone, $email, $firstName]);
        if ($existingUser) {
            echo '<script>alert("Пользователь с таким телефоном, почтой или логином уже существует.");</script>';
        } else {
...
<div class="container" >
  <div class="d-flex md-12">
    ...
    <svg xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg" xmlns:svg="http://www.w3.org/2000/svg" version="1.0" width="100%"  viewBox="0 0 694.34644 341.18503" id="svg2041">
    <defs>
                ...
                <H1 style="color:white;">Регистрация:</H1>
                        <form method="post" action="index.php">
                            <div class="form-group text-center">
                                ...
                                <input type="text" class="form-control" id="firstName" name="firstName" placeholder="Введите логин" required>
                            </div>
                            <div class="form-group text-center">
                                <label for="lastName">Фамилия:</label>
                                <input type="text" class="form-control" id="lastName" name="lastName" placeholder="Введите ФИО" required>
                            </div>
                            <div class="form-group text-center">
                            ...
                            <button type="submit" class="btn btn-primary logout_btn">Зарегистрироваться</button>
                            <a href="login.php" class="btn btn-link text-center">Войти</a>
                        </form>
                    </div>
                </div>
            </div>
