        ...
        if ($user) {
            if (password_verify($password, $user['password'])) {
                ...
                if ($user['role'] == "Пользователь") {
                    header("Location: /examples/main_page.php");
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                ...
                <form method="post" action="login.php" >
                    ...
                    <button type="submit" class="btn btn-primary logout_btn">Войти</button>
                   <div class="col-md-12 text-center">
     
    				
                   <?php echo '<a href="forgot.php" class="btn btn-link  text-center ">Забыли пароль?</a>'?>
                   <?php echo '<a href="index.php" class="btn btn-link  text-center ">Регистрация</a>'?>
                    </div>
                </form>
            </div>
        </div>
